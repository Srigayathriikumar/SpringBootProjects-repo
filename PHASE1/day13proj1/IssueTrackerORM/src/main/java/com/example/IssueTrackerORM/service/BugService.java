...
public class BugService {
    ...
    public List<Bug> findByProjectId(int project_id){
        return bugRepository.findByProject_Id(project_id);
    }
    ...
    public long countByProjectId(int project_id) {
        return bugRepository.countByProjectId(project_id);
    }
